...
class LangizakoPdfSOE extends StatefulWidget {
  @override
  _LangizaPdfState createState() => _LangizaPdfState();
}

class _LangizaPdfState extends State<LangizakoPdfSOE> {
  ...
  Future<void> _listFiles() async {
    final firebase_storage.ListResult result =
        await firebase_storage.FirebaseStorage.instance
            .ref()
            .child('pdfs/School of Education') // Specify the folder path here
            .listAll();
