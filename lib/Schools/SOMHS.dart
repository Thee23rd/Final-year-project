...
class LangizakoPdfSOMHS extends StatefulWidget {
  @override
  _LangizaPdfState createState() => _LangizaPdfState();
}

class _LangizaPdfState extends State<LangizakoPdfSOMHS> {
  ...
  Future<void> _listFiles() async {
    final firebase_storage.ListResult result = await firebase_storage
        ...
        .ref()
        .child(
            'pdfs/School of Medicine and Health Science') // Specify the folder path here
        .listAll();
