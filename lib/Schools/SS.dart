...
class LangizakoPdfSS extends StatefulWidget {
  @override
  _LangizaPdfState createState() => _LangizaPdfState();
}

class _LangizaPdfState extends State<LangizakoPdfSS> {
  ...
  Future<void> _listFiles() async {
    final firebase_storage.ListResult result = await firebase_storage
        ...
        .ref()
        .child('pdfs/School of Social Science') // Specify the folder path here
        .listAll();
